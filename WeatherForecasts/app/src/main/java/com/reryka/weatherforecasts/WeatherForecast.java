...
public class WeatherForecast {
    ...
    public WeatherForecast(JSONObject jsonObject)throws JSONException{
        ...
        for(int i = 0; i < len; i++){
            JSONObject forecvastJson = forecastArray.getJSONObject(i);
            Forecast forecast = new Forecast(forecvastJson);
    ...
    public static class Temperature{
        ...
        public String toString(){
            ...
            // 最低気温/最高気温
            if(min.celsius != null){
                stringBuffer.append(min.celsius);
            }else{
                stringBuffer.append(" - ");
            }
            stringBuffer.append("℃ / ");
            ...
            if(max.celsius != null){
                stringBuffer.append(max.celsius);
            }else{
                stringBuffer.append(" - ");
            }
            stringBuffer.append("℃");
